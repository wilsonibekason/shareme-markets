// initializing the categories for better performance
...
// initailizing userQuery
export const userQuery = (userId) => {
  const query = `*[_type == "user" && _id == '${userId}']`;
  return query;
};

// initialising feedQuery for generating user pictures or to put it right Feed
