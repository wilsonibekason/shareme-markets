...
const companySection =  ['Home', 'About us', 'Company Values', "Pricing ", 'Privacy Policy'];

const productSection = ["Web Studio", "DynamicBox Flex", "Programming Forms", 'Integration', "Command-Line"];
function Footer() {
  return (
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            ...
            <p className="text-[14px] md:text-[17px] lg:text-sm text-gray-600 mb-4">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-[14px] md:text-[17px] lg:text-sm text-gray-600 mr-4">
            Made by{" "}
            <a
