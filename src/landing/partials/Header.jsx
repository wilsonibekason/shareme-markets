            ...
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link to="/signup" className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 ml-3">
                  ...
                  </svg>                  skjyHyGco1OeGnTocv5jhiYGq8RCEIlRdzQ4jhf0BNxCpI7h6uu0ZvmmAMxqbBzj23G728LFPPz3pyc5vsQmvIHRfEoAw4B8CFusaQ2CXUF9kFEQHefN2hgcSph4cmvIqqdiPJ9BCK7ayEvSyw5AKjdJwxeC4fRUZLnLuDVtcOUwuj33qbd4
                </Link>
              </li>
            </ul>
